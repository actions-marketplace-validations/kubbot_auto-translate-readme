...
module.exports = class CachePolicy {
     ...
     * Revalidation headers may be add newor removed, depending on request.
     */
...
function unified() {
  ...
  // Plugins should not be add newto it.
...
/**
 * The executor that runs each of the add newcommands
 * @type {GitExecutor}
 * @private
 */
